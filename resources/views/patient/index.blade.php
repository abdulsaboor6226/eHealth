        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex justify-content-end mb-2 mr-3">
                    <a type="button" class="btn btn-primary btn-icon-text" href="{{ route('patient.create') }}"><i class="ti-plus btn-icon-prepend"></i>Add Patient
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="">
                        <span class="badge">
                            <a data-toggle="collapse" href="#patient" class="text-primary" aria-expanded="false" aria-controls="filter">
                ...
                <form action="{{ route('patient.index') }}" method="GET">
                    <div class="collapse {{ request()->all() ? 'show' : ' ' }}" id="patient">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="d-flex justify-content-end mt-2">
                            ...
                            <a class="badge badge-outline-primary" href="{{ route('patient.index') }}"><i
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="">
                        <p class="text-right"> Total Record {{ $totalPatients }}</p>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($patients as $key => $patient)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td><img src="{{$patient->profile_image_url}}" onerror="profileImgError(this);" alt="image"></td>
                                    <td>{{ $patient->name }}</td>
                                    <td>{{ $patient->email }}</td>
                                    <td>{{ $patient->phone }}</td>
                                    <td>
                                        <span class="badge badge-outline-primary">{{ ucfirst($patient->roles->first()->name) }}</span>
                                    </td>
                                    <td><span class="badge badge-outline-{{$patient->status->meta['color']}}">{{$patient->status->value}}</span></td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" style="">
                                                @can('admin.edit')
                                                    <a class="dropdown-item" href="{{ route('patient.edit', $patient->id) }}"><i
                                                ...
                                                @can('admin.delete')
                                                    <a class="dropdown-item" onclick='swal({
                                                            ...
                                                            function(){
                                                            document.getElementById("delete-job-{{ $patient->id }}").submit();
